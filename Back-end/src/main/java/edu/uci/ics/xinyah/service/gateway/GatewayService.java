package edu.uci.ics.xinyah.service.gateway;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.dataformat.yaml.YAMLFactory;
import edu.uci.ics.xinyah.service.gateway.configs.*;
import edu.uci.ics.xinyah.service.gateway.configs.*;
import edu.uci.ics.xinyah.service.gateway.connectionpool.ConnectionPoolManager;
...
public class GatewayService {
    ...
    public static final String RESOURCE_PATH = "edu.uci.ics.xinyah.service.gateway.resources";
    ...
    private void initService(String[] args) {
        ...
        for(int i = 0; i<threadConfigs.getNumThreads();i++)
        {
            threadPool.getWorkers().get(i).start();
        }
