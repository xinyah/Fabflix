...
public class CartClear {
    @Path("cart/clear")
    @POST
    public Response clear(@Context HttpHeaders headers, @Context UriInfo uriInfo, String jsonText)
    {
        ...
        return  Response.noContent()
                ...
                .header("session_id",checkSession.session_id())
                .build();
    }
}
